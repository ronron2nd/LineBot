...
def broadcast():
    ...
    try:
        ...
        prompt = f"""
        今日は{today_str}です。この日に関する日本の雑学・記念日・歴史的な出来事・文化などを簡潔に紹介してください。
        
        ・最初に「今日は{today_str}は〜の日です」などと主題を明確に書いてください。
        ・前置きや余談は書かないでください。
        ・話し言葉ではなく、ですます調の文体で書いてください。
        ・読みやすく簡単な日本語で、300〜500文字程度にまとめてください。
        ・文章の始めに「はい、」や「さて、」などの語り口を使わないでください。
        """
